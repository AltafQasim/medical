const DebitCard = () => {
    return <div className="flex xs-mx:min-h-48 w-full sm-mx:min-h-60 min-h-80 my-2 p-4 bg-orange-100 justify-evenly items-center">
        <div className="flex gap-6 flex-col">
            ...
            <div className="xs-mx:text-sm sm-mx:text-base md-mx:text-lg text-xl">on MyCart.com</div>
        ...
        <img className="xs-mx:hidden md-mx:w-[28vw] lg-mx:w-[35vw] absolute top-4 -right-4 -rotate-[20deg]" src="../../MyCart/Images/debitcard2.png" />
        <img className="xs-mx:hidden md-mx:w-[28vw] lg-mx:w-[35vw] -rotate-[30deg] z-10" src="../../MyCart/Images/debitcard.png" />
        </div>
    </div>
}
