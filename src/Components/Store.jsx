    ...
    return <div className="flex flex-col gap-1 mb-2 md-mx:w-[48%]">
        <div className="relative mb-4 rounded-xl w-fit">
            <div className=" overflow-hidden rounded-xl">
                <img className="hover:scale-[1.2] hover:rotate-3 transform transition-transform duration-[400ms] " src={`../../Medical/Images/${name}bg.png`} />
            </div>
            <img className="absolute border-2 rounded-full -bottom-6 left-5 w-14" src={`../../Medical/Images/${name}.png`}  />
        </div>
